    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="/" class="logo">
                ...
                <span class="logo-lg"><img src="/img/potted-pan_logo_full.png" class="d-inline-block align-top"
                        alt="logo"></span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href="{{route('slidelisting')}}"><i class="fa fa-book"></i> <span>Slide</span></a></li>
